package curs.narcis.unitconverter
...
import curs.narcis.unitconverter.ui.theme.UnitConverterTheme
...
fun UnitConverter(){
    ...
    fun convertUnits(){
        ...
        val result = inputValueDouble * iConversionFactor.doubleValue * 100.0 / oConversionFactor.doubleValue / 100
